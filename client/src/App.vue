    ...
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      ...
      <button class="sidebar-toggle" @click="toggleSidebar" :title="sidebarCollapsed ? 'Expand sidebar' : 'Collapse sidebar'">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
          ...
          <path v-if="!sidebarCollapsed" stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
      ...
      <div class="sidebar-logo">
        ...
        <div class="sidebar-logo-text" v-show="!sidebarCollapsed">
          <h1>FactoryOS</h1>
          <span class="subtitle">Inventory</span>
        </div>
      </div>
      ...
      <div class="sidebar-footer">
        <div class="sidebar-footer-items" v-show="!sidebarCollapsed">
          <LanguageSwitcher />
          <ProfileMenu
...
export default {
  ...
  setup() {
    ...
    // Track collapsed state — auto-collapse on small screens
    ...
    // Auto-collapse on resize below 768px, expand above
    const handleResize = () => {
...
.sidebar {
  ...
  height: 100vh;
  z-index: 100;
  box-shadow: 1px 0 3px 0 rgba(0, 0, 0, 0.04);
